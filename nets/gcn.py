...
class StandGCN2(nn.Module):
    def __init__(self, nfeat, nhid, nclass, dropout,nlayer=2):
        ...
        self.reg_params = list(self.conv1.parameters()) + list(self.linear1.parameters())
        self.non_reg_params = list(self.conv2.parameters()) + list(self.linear2.parameters())

    def forward(self, x, adj, edge_weight=None):
        x = self.conv1(x,adj, edge_weight)
        x = F.relu(x)
